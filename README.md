...
**술이술이홈술이**는 술자리 분위기를 제대로 느낄 수 있도록 술자리 테마와 음악을 공유할 수 있습니다. 또한, 사용자들이 술자리를 즐길 수 있도록 실제 술자리에서 진행하는 5종의 온라인 술게임과 노래방 기능, 스냅샷 기능을 지원합니다. 더불어 술이술이홈술이는 건전한 술문화를 장려하기 위해 주량 체크 기능과, 사용자의 주취여부를 파악해주는 나술안취했어 기능이 포함되어 있습니다. 이외에도, 사용자의 술자리 기록을 마이페이지의 캘린더와 통계를 통해 한 눈에 확인할 수 있습니다.
