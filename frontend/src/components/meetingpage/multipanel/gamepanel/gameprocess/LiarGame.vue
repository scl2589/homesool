<template>
    <div class="panel">
        <div class="selectgame h-100" v-if="gameStatus==1">
          <div class="h-100 d-flex align-items-center justify-content-center" v-if="notModeHost">
        ...
        <div class="startgame h-100" v-if="gameStatus==2">
            ...
            <div class="voteForLiar  h-100" v-if="gameTurn==2">
              ...
              <div class="voteProcess d-flex flex-column justify-content-between h-100" v-else>
